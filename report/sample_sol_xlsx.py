...
class ImportSOLXLSX(models.AbstractModel):
    _name = 'report.download_sample_sol_xlsx'
    _inherit = "report.report_xlsx.abstract"
    _description = 'Download Sample SOL XLSX'
    ...
    def generate_xlsx_report(self, workbook, data, records):
        sheet = workbook.add_worksheet("Sale Order Lines")
